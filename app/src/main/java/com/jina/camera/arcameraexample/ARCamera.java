...
public class ARCamera extends ViewGroup implements SurfaceHolder.Callback { // * AR카메라를 위한 커스텀뷰
    ...
    ///////////////////////////////////////// * 뷰그룹을 상속받아 커스텀뷰를 생성하기 위해 오버라이딩한 메서드
    ...
    ///////////////////////////////////////// * 커스텀뷰를 서페이스뷰로 생성하기 위해 오버라이딩한 메서드
    // * 서페이스뷰는 뷰를 상속받아 비디오 메모리에 바로 접근하기 때문에 일반 뷰보다 랜더링 속도가 빠르다
